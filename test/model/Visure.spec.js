...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Visure', function() {
      beforeEach(function() {
        instance = new Visengine20.Visure();
      });

      it('should create an instance of Visure', function() {
        // TODO: update the code to test Visure
        expect(instance).to.be.a(Visengine20.Visure);
      });
