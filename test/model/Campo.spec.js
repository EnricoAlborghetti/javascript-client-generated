...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Campo', function() {
      beforeEach(function() {
        instance = new Visengine20.Campo();
      });

      it('should create an instance of Campo', function() {
        // TODO: update the code to test Campo
        expect(instance).to.be.a(Visengine20.Campo);
      });
